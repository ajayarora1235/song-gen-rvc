...
index_root = os.path.join(now_dir, "assets", "indices")
...
index_root_relative = os.path.relpath(index_root, now_dir)
...
indexes_list = [
    ...
    for root, _, files in os.walk(index_root_relative, topdown=False)
    for name in files
